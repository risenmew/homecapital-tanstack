...
import { translation, type TranslationKey } from "../../translation";
...
export const LocalesProvider = ({ children }: { children: React.ReactElement }) => {
  ...
  return (
    <LocalesContext.Provider value={{ lang, toggleLang, t }}>{children}</LocalesContext.Provider>
  );
};
